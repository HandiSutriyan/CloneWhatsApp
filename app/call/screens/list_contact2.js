					...
					<List style={{backgroundColor:'#FFF'}}>
						{this.props.contacts.results.map((item,i)=>{
							return(
								...
								<Right><Icon name='call' style={{color:'#128C7E',fontSize:20,marginRight:25}}/></Right>
								<Right><Icon name='videocam' style={{color:'#128C7E',fontSize:20,marginRight:25}}/></Right>
								</ListItem>
								)
						})}
					</List>
...
export default connect(mapStateToProps)(Contact2);